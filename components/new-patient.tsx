...
export const NewPatient = ({ data, type }: DataProps) => {
  ...
  return (
    <Card className="max-w-6xl w-full p-4  ">
      <CardHeader>
        <CardTitle className="font-serif text-blue-800">Patient Registration</CardTitle>
        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="space-y-8">
              <h3 className="text-lg font-semibold text-blue-800">Family Information</h3>
              <CustomInput
                type="input"
                control={form.control}
            ...
            {type !== "update" && (
              <div className="">
                <h3 className="text-lg font-semibold mb-2 text-blue-800">Consent</h3>
            ...
            <Button
              disabled={loading}
              type="submit"
              className="w-full md:w-fit px-6 bg-blue-800"
            >
