...
export const PatientFormSchema = z.object({
  ...
  phone: z.string().min(1, "Enter phone number").max(10, "Enter phone number"),
...
export const DoctorSchema = z.object({
  ...
  phone: z.string().min(0, "Enter phone number").max(10, "Enter phone number"),
  email: z.string().email("Invalid email address."),
  address: z
    .string()
    .min(5, "Address must be at least 5 characters")
...
export const StaffSchema = z.object({
  ...
  phone: z
    .string()
    .min(0, "Contact must be min 9-digits")
